...
### Dual Prompt Approach (2)
```
ช่วยรวบรวมความรู้เกี่ยวกับหลักโภชนาการพื้นฐานและสัดส่วนสารอาหารที่เหมาะสมต่อมื้อ (คาร์โบไฮเดรต โปรตีน ไขมัน) พร้อมข้อควรระวังเรื่องปริมาณน้ำตาลและโซเดียม 
```
```
อ้างอิงจากองค์ความรู้ข้างต้นจัดทำเมนูอาหารสุขภาพ 5 วัน (เช้า-กลางวัน-เย็น) 
