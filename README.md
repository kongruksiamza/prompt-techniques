...
```
ในฐานะที่คุณเป็นนักประวัติศาสตร์ ช่วยอธิบายสาเหตุหลักที่ทำให้เกิดสงครามโลกครั้งที่ 2 พร้อมแสดงขั้นตอนการวิเคราะห์และเหตุผลที่อยู่เบื้องหลังแต่ละสาเหตุที่คุณระบุ
```
